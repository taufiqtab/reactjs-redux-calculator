            ...
            <div className='row'>
                <div className='col-sm9'>
                    <div className="row mb-2">
                        ...
                        <div className="col-sm-4">
                            <button className="btn-block btn-lg btn-default" onClick={()=>{this.props.pressButton(9)}}>9</button>
                        </div>
                    </div>
                    ...
                    <div className="row mb-2">
                        ...
                        <div className="col-sm-4">
                            <button className="btn-block btn-lg btn-default" onClick={()=>{this.props.pressButton(6)}}>6</button>
                        </div>
                    </div>
                    ...
                    <div className="row mb-2">
                        ...
                        <div className="col-sm-4">
                            <button className="btn-block btn-lg btn-default" onClick={()=>{this.props.pressButton(3)}}>3</button>
                        </div>
                    </div>

                    <div className="row mb-2">
                        <div className="col-sm-4">
                            <button className="btn-block btn-lg btn-default" onClick={()=>{this.props.pressButton('.')}}>.</button>
                        </div>
                        <div className="col-sm-4">
                            <button className="btn-block btn-lg btn-default" onClick={()=>{this.props.pressButton(0)}}>0</button>
                        </div>
                        <div className="col-sm-4">
                            <button className="btn-block btn-lg btn-danger" onClick={()=>{this.props.pressReset()}}>C</button>
                        </div>
                    </div>
                </div>
                ...
                <div className="col-sm-3">
                    <div className="row mb-2">
                        <div className="col-sm-6">
                            <button className="btn-block btn-lg btn-primary" onClick={()=>{this.props.pressButton('+')}}>+</button>
                        </div>
                        <div className="col-sm-6">
                            <button className="btn-block btn-lg btn-primary" onClick={()=>{this.props.pressButton('-')}}>-</button>
                        </div>
                    ...
                    <button className="btn-block btn-lg btn-success" onClick={()=>{this.props.pressEqual()}}>=</button>
                </div>
            </div>
        )
    }
